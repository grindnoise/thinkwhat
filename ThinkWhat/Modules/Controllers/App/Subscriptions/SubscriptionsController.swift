...
//    private var isRightButtonSpinning = false {
//        didSet {
//            guard oldValue != isRightButtonSpinning,
//                  let button = rightButton.getSubview(type: UIButton.self, identifier: "button")
//            else { return }
//
//            if isRightButtonSpinning {
//                let spinner = UIActivityIndicatorView()
//                spinner.accessibilityIdentifier = "spinner"
//                spinner.color = .white
//                spinner.startAnimating()
//                spinner.place(inside: button)
//            } else if let spinner = button.getSubview(type: UIActivityIndicatorView.self, identifier: "spinner") {
...
////        constraint.isActive = true
////
////        instance.layer.addSublayer(leftGradient)
...
////                                    withConfiguration: UIImage.SymbolConfiguration(pointSize: rect.height * 0.45,
////                                                                                   weight: .semibold,
////                                                                                   scale: .medium))
...
////            .store(in: &subscriptions)
////
////        button.addTarget(self, action: #selector(self.handleBarButtonTap(sender:)), for: .touchUpInside)
...
////        instance.layer.shadowOffset = .zero
////        instance.widthAnchor.constraint(equalTo: instance.heightAnchor, multiplier: 1/1).isActive = true
////        instance.layer.addSublayer(rightGradient)
////        instance.publisher(for: \.bounds, options: .new)
////            .sink { rect in
////                instance.layer.shadowPath = UIBezierPath(ovalIn: rect).cgPath
////
...
//        super.traitCollectionDidChange(previousTraitCollection)
//
//        leftButton.layer.shadowOpacity = traitCollection.userInterfaceStyle == .dark ? 0 : 1
//        rightButton.layer.shadowOpacity = traitCollection.userInterfaceStyle == .dark ? 0 : 1
//        leftGradient.colors = getGradientColors()
//        rightGradient.colors = getGradientColors()
//    }
//}
//
//private extension SubscriptionsController {
...
//
//        NSLayoutConstraint.activate([
//            leftButton.leadingAnchor.constraint(equalTo: navigationBar.leadingAnchor, constant: 10),
...
//            rightButton.bottomAnchor.constraint(equalTo: navigationBar.bottomAnchor, constant: -2),
//            rightButton.topAnchor.constraint(equalTo: navigationBar.topAnchor, constant: 2),
//            rightButton.trailingAnchor.constraint(equalTo: navigationBar.trailingAnchor, constant: -10),
//        ])
//
//        let constraint = titleLabel.leadingAnchor.constraint(equalTo: leftButton.trailingAnchor, constant: 0)
//        constraint.identifier = "leading"
//        constraint.isActive = true
//
////        setBarItems()
...
//        switch mode {
//        case .Userprofile:
//            guard let button = rightButton.getSubview(type: UIButton.self, identifier: "button"),
//                  let userprofile = userprofile,
//                  let notify = userprofile.notifyOnPublication,
//                  let height = leftButton.getConstraint(identifier: "height"),
//                  let leading = titleLabel.getConstraint(identifier: "leading")
//            else { return }
//
//            let _ = UIViewPropertyAnimator.runningPropertyAnimator(withDuration: 0.15,
...
//            }
//
//            button.setImage(UIImage(systemName: notify ? "bell.and.waves.left.and.right.fill" : "bell.slash.fill",
//                                    withConfiguration: UIImage.SymbolConfiguration(pointSize: button.bounds.height * 0.45,
//                                                                                   weight: .semibold,
//                                                                                   scale: .medium)),
//                            for: .normal)
//
...
//            text = userprofile.name
//        case .Default:
//            text = "subscriptions".localized + (period == .AllTime ? "" : " " + "per".localized.lowercased() + " \(period.rawValue.localized.lowercased())")
//        }
//
//        guard animated else {
//            titleLabel.text = text
...
//
//    @objc @MainActor
//    func handleBarButtonTap(sender: UIButton) {
//        switch mode {
//        case .Userprofile:
//            guard let userprofile = userprofile,
//                  let notify = userprofile.notifyOnPublication,
...
//            else { return }
//
//            isRightButtonSpinning = true
//            controllerInput?.switchNotifications(userprofile: userprofile,
//                                                      notify: !notify)
//        case .Default:
//            fatalError()
//        }
