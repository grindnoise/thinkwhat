...
class UsersFilterAgeCell: UICollectionViewCell {
  ...
  private lazy var rangeSlider: TTRangeSlider = {
    ...
    instance.handleColor = color//traitCollection.userInterfaceStyle == .dark ? .systemBlue : K_COLOR_RED
    instance.tintColorBetweenHandles = color//traitCollection.userInterfaceStyle == .dark ? .systemBlue : K_COLOR_RED
...
//    rangeSlider.handleColor = color//traitCollection.userInterfaceStyle == .dark ? .systemBlue : K_COLOR_RED
//    rangeSlider.tintColorBetweenHandles = color.withAlphaComponent(0.6)//traitCollection.userInterfaceStyle == .dark ? .systemBlue : K_COLOR_RED.withAlphaComponent(0.6)
//  }
}
