...
//            guard let content = content else { return }
    ...
    private lazy var verticalStackView: UIStackView = {
        ...
        NSLayoutConstraint.activate([
            topContainer.heightAnchor.constraint(equalToConstant: 100),//equalTo: instance.heightAnchor, multiplier: 0.2),
...
//    }
    ...
    override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
        ...
        if !image.isNil || !systemImage.isNil {
            imageView.tintColor = traitCollection.userInterfaceStyle == .dark ? .systemBlue : K_COLOR_RED
        } else {
