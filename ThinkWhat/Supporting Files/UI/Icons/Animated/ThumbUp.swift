...
@IBDesignable
class ThumbUp: AnimatedIcon, CAAnimationDelegate {
    ...
    func setupProperties(){
        ...
        self.active = Constants.UI.Colors.System.Red.rawValue//Colors.UpperButtons.VioletBlueCrayola//Colors.UpperButtons.HoneyYellow//K_COLOR_RED//UIColor(red:1.00, green: 0.15, blue:0.00, alpha:1.0)
    }
