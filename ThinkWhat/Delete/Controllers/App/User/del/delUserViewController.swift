...
//import UIKit
//
//class delUserViewController: UIViewController {
//
//    deinit {
...
//                                               selector: #selector(delUserViewController.profileImageReceived(_:)),
...
//            API.shared.getUserStats(userProfile: userProfile) {
//                json, error in
//                if error != nil {
...
//
//
//extension delUserViewController: UIScrollViewDelegate {
...
//}
//
//extension delUserViewController: UITableViewDataSource, UITableViewDelegate {
...
//            cell.count.text = "\(userProfile.publicationsTotal)"
...
//            cell.count.text = "\(userProfile.completeTotal)"
//            cell.separatorInset = UIEdgeInsets(top: 0, left: leftEdgeInset, bottom: 0, right: 0)
//            return cell
...
//            cell.count.text = "\(userProfile.favoritesTotal)"
//            return cell
...
//        if indexPath.row == 0 {
//            if userProfile.surveys.values.first!.isEmpty || esteemMinutes(date: userProfile.surveys.keys.first!) {
//                setNeedsAwaitForNotification = true
//                API.shared.loadSurveysByOwner(userProfile: userProfile, type: .User) {
//                    json, error in
//                    if error != nil {
//                        print(error?.localizedDescription)
//                    } else if json != nil {
...
//            if userProfile.favorites.values.first!.isEmpty || esteemMinutes(date: userProfile.favorites.keys.first!) {
//                setNeedsAwaitForNotification = true
//                API.shared.loadSurveysByOwner(userProfile: userProfile, type: .UserFavorite) {
//                    json, error in
//                    if error != nil {
//                        print(error?.localizedDescription)
//                    } else if json != nil {
...
//}
//
//extension delUserViewController: CallbackDelegate {
//    func callbackReceived(_ sender: Any) {
//        if let _sender = sender as? UISwitch {
//            API.shared.subsribeToUserProfile(subscribe: _sender.isOn, userprofile: userProfile) {
//                json, error in
//
//            }
//        }
