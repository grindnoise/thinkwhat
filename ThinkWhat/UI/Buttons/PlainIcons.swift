...
public class PlainIconsStyleKit : NSObject {
    ...
    @objc public dynamic class func drawNotification(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 553, height: 553), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 323.59, y: 103.91))
        bezierPath.addCurve(to: CGPoint(x: 322.55, y: 116.64), controlPoint1: CGPoint(x: 319.11, y: 108.25), controlPoint2: CGPoint(x: 318.81, y: 112.14))
        bezierPath.addCurve(to: CGPoint(x: 339.74, y: 119.78), controlPoint1: CGPoint(x: 325.09, y: 119.78), controlPoint2: CGPoint(x: 326.43, y: 119.93))
        bezierPath.addCurve(to: CGPoint(x: 445.57, y: 183.26), controlPoint1: CGPoint(x: 385.33, y: 119.03), controlPoint2: CGPoint(x: 425.84, y: 143.29))
        bezierPath.addCurve(to: CGPoint(x: 457.08, y: 239.26), controlPoint1: CGPoint(x: 454.84, y: 202.13), controlPoint2: CGPoint(x: 457.83, y: 216.65))
        bezierPath.addCurve(to: CGPoint(x: 451.4, y: 272.65), controlPoint1: CGPoint(x: 456.48, y: 255.58), controlPoint2: CGPoint(x: 455.74, y: 260.07))
        bezierPath.addCurve(to: CGPoint(x: 448.86, y: 290.92), controlPoint1: CGPoint(x: 446.92, y: 286.28), controlPoint2: CGPoint(x: 446.77, y: 287.47))
        bezierPath.addCurve(to: CGPoint(x: 461.72, y: 294.96), controlPoint1: CGPoint(x: 451.7, y: 295.11), controlPoint2: CGPoint(x: 457.83, y: 297.06))
        bezierPath.addCurve(to: CGPoint(x: 470.39, y: 280.59), controlPoint1: CGPoint(x: 464.11, y: 293.61), controlPoint2: CGPoint(x: 469.19, y: 285.23))
        bezierPath.addCurve(to: CGPoint(x: 473.97, y: 267.11), controlPoint1: CGPoint(x: 470.53, y: 279.69), controlPoint2: CGPoint(x: 472.18, y: 273.7))
        bezierPath.addCurve(to: CGPoint(x: 468.29, y: 184.01), controlPoint1: CGPoint(x: 480.4, y: 243.6), controlPoint2: CGPoint(x: 477.86, y: 206.17))
        bezierPath.addCurve(to: CGPoint(x: 440.04, y: 141.19), controlPoint1: CGPoint(x: 461.72, y: 168.59), controlPoint2: CGPoint(x: 452, y: 153.92))
        bezierPath.addCurve(to: CGPoint(x: 411.79, y: 118.58), controlPoint1: CGPoint(x: 434.81, y: 135.5), controlPoint2: CGPoint(x: 419.26, y: 123.07))
        bezierPath.addCurve(to: CGPoint(x: 375.91, y: 103.76), controlPoint1: CGPoint(x: 404.61, y: 114.09), controlPoint2: CGPoint(x: 382.94, y: 105.26))
        bezierPath.addCurve(to: CGPoint(x: 341.98, y: 100.17), controlPoint1: CGPoint(x: 361.41, y: 100.92), controlPoint2: CGPoint(x: 354.69, y: 100.17))
        bezierPath.addCurve(to: CGPoint(x: 323.59, y: 103.91), controlPoint1: CGPoint(x: 328.23, y: 100.17), controlPoint2: CGPoint(x: 326.88, y: 100.47))
        bezierPath.close()
        UIColor.white.setFill()
        bezierPath.fill()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 334.95, y: 142.24))
        bezier2Path.addCurve(to: CGPoint(x: 324.34, y: 152.12), controlPoint1: CGPoint(x: 327.93, y: 143.14), controlPoint2: CGPoint(x: 324.34, y: 146.43))
        bezier2Path.addCurve(to: CGPoint(x: 344.67, y: 162), controlPoint1: CGPoint(x: 324.34, y: 159.01), controlPoint2: CGPoint(x: 328.68, y: 160.96))
        bezier2Path.addCurve(to: CGPoint(x: 382.04, y: 172.93), controlPoint1: CGPoint(x: 361.26, y: 162.9), controlPoint2: CGPoint(x: 370.83, y: 165.75))
        bezier2Path.addCurve(to: CGPoint(x: 414.03, y: 216.8), controlPoint1: CGPoint(x: 398.19, y: 183.12), controlPoint2: CGPoint(x: 408.95, y: 197.94))
        bezier2Path.addCurve(to: CGPoint(x: 412.69, y: 257.38), controlPoint1: CGPoint(x: 416.72, y: 227.13), controlPoint2: CGPoint(x: 416.12, y: 246.3))
        bezier2Path.addCurve(to: CGPoint(x: 412.24, y: 275.65), controlPoint1: CGPoint(x: 408.95, y: 269.36), controlPoint2: CGPoint(x: 408.8, y: 272.8))
        bezier2Path.addCurve(to: CGPoint(x: 433.16, y: 258.13), controlPoint1: CGPoint(x: 421.21, y: 283.58), controlPoint2: CGPoint(x: 428.38, y: 277.59))
        bezier2Path.addCurve(to: CGPoint(x: 407.3, y: 167.84), controlPoint1: CGPoint(x: 441.39, y: 224.74), controlPoint2: CGPoint(x: 431.52, y: 190.45))
        bezier2Path.addCurve(to: CGPoint(x: 334.95, y: 142.24), controlPoint1: CGPoint(x: 386.38, y: 148.23), controlPoint2: CGPoint(x: 359.62, y: 138.8))
        bezier2Path.close()
        UIColor.white.setFill()
        bezier2Path.fill()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 185.47, y: 154.37))
        bezier3Path.addCurve(to: CGPoint(x: 177.85, y: 186.71), controlPoint1: CGPoint(x: 172.92, y: 160.81), controlPoint2: CGPoint(x: 169.63, y: 175.33))
        bezier3Path.addCurve(to: CGPoint(x: 182.33, y: 193.6), controlPoint1: CGPoint(x: 180.39, y: 190.15), controlPoint2: CGPoint(x: 182.33, y: 193.3))
        bezier3Path.addCurve(to: CGPoint(x: 175.46, y: 198.24), controlPoint1: CGPoint(x: 182.33, y: 193.9), controlPoint2: CGPoint(x: 179.19, y: 195.99))
        bezier3Path.addCurve(to: CGPoint(x: 149.15, y: 225.34), controlPoint1: CGPoint(x: 166.04, y: 203.78), controlPoint2: CGPoint(x: 154.08, y: 216.05))
        bezier3Path.addCurve(to: CGPoint(x: 150.64, y: 332.99), controlPoint1: CGPoint(x: 137.04, y: 247.95), controlPoint2: CGPoint(x: 137.34, y: 267.56))
        bezier3Path.addCurve(to: CGPoint(x: 147.21, y: 399.17), controlPoint1: CGPoint(x: 158.27, y: 370.12), controlPoint2: CGPoint(x: 157.67, y: 379.26))
        bezier3Path.addCurve(to: CGPoint(x: 151.54, y: 434.66), controlPoint1: CGPoint(x: 138.68, y: 415.19), controlPoint2: CGPoint(x: 140.48, y: 429.41))
        bezier3Path.addCurve(to: CGPoint(x: 184.58, y: 430.31), controlPoint1: CGPoint(x: 159.46, y: 438.4), controlPoint2: CGPoint(x: 168.28, y: 437.35))
        bezier3Path.addCurve(to: CGPoint(x: 248.11, y: 407.11), controlPoint1: CGPoint(x: 187.12, y: 429.27), controlPoint2: CGPoint(x: 215.67, y: 418.93))
        bezier3Path.addCurve(to: CGPoint(x: 310.14, y: 384.5), controlPoint1: CGPoint(x: 280.54, y: 395.43), controlPoint2: CGPoint(x: 308.5, y: 385.25))
        bezier3Path.addCurve(to: CGPoint(x: 352, y: 369.37), controlPoint1: CGPoint(x: 312.68, y: 383.3), controlPoint2: CGPoint(x: 337.05, y: 374.62))
        bezier3Path.addCurve(to: CGPoint(x: 360.96, y: 365.93), controlPoint1: CGPoint(x: 354.54, y: 368.63), controlPoint2: CGPoint(x: 358.57, y: 366.98))
        bezier3Path.addCurve(to: CGPoint(x: 378.01, y: 359.79), controlPoint1: CGPoint(x: 363.51, y: 364.88), controlPoint2: CGPoint(x: 371.13, y: 362.04))
        bezier3Path.addCurve(to: CGPoint(x: 394.6, y: 351.56), controlPoint1: CGPoint(x: 384.88, y: 357.4), controlPoint2: CGPoint(x: 392.36, y: 353.65))
        bezier3Path.addCurve(to: CGPoint(x: 378.45, y: 313.53), controlPoint1: CGPoint(x: 407.9, y: 339.43), controlPoint2: CGPoint(x: 399.53, y: 319.82))
        bezier3Path.addCurve(to: CGPoint(x: 363.36, y: 305.29), controlPoint1: CGPoint(x: 374.27, y: 312.18), controlPoint2: CGPoint(x: 367.54, y: 308.59))
        bezier3Path.addCurve(to: CGPoint(x: 343.77, y: 281.63), controlPoint1: CGPoint(x: 355.73, y: 299.3), controlPoint2: CGPoint(x: 343.77, y: 284.78))
        bezier3Path.addCurve(to: CGPoint(x: 342.73, y: 279.84), controlPoint1: CGPoint(x: 343.77, y: 280.59), controlPoint2: CGPoint(x: 343.33, y: 279.84))
        bezier3Path.addCurve(to: CGPoint(x: 339.89, y: 276.39), controlPoint1: CGPoint(x: 341.98, y: 279.84), controlPoint2: CGPoint(x: 340.78, y: 278.34))
        bezier3Path.addCurve(to: CGPoint(x: 333.46, y: 264.42), controlPoint1: CGPoint(x: 338.99, y: 274.6), controlPoint2: CGPoint(x: 336.15, y: 269.21))
        bezier3Path.addCurve(to: CGPoint(x: 324.49, y: 247.65), controlPoint1: CGPoint(x: 330.92, y: 259.77), controlPoint2: CGPoint(x: 326.88, y: 252.14))
        bezier3Path.addCurve(to: CGPoint(x: 293.7, y: 203.18), controlPoint1: CGPoint(x: 316.87, y: 233.57), controlPoint2: CGPoint(x: 300.87, y: 210.51))
        bezier3Path.addCurve(to: CGPoint(x: 239.88, y: 179.37), controlPoint1: CGPoint(x: 276.51, y: 185.96), controlPoint2: CGPoint(x: 260.81, y: 178.92))
        bezier3Path.addCurve(to: CGPoint(x: 222.25, y: 179.97), controlPoint1: CGPoint(x: 232.56, y: 179.52), controlPoint2: CGPoint(x: 224.49, y: 179.82))
        bezier3Path.addCurve(to: CGPoint(x: 217.61, y: 172.63), controlPoint1: CGPoint(x: 218.06, y: 180.27), controlPoint2: CGPoint(x: 217.91, y: 179.97))
        bezier3Path.addCurve(to: CGPoint(x: 185.47, y: 154.37), controlPoint1: CGPoint(x: 216.56, y: 155.57), controlPoint2: CGPoint(x: 200.57, y: 146.43))
        bezier3Path.close()
        UIColor.white.setFill()
        bezier3Path.fill()
        ...
        //// Bezier 4 Drawing
        let bezier4Path = UIBezierPath()
        bezier4Path.move(to: CGPoint(x: 336.9, y: 184.31))
        bezier4Path.addCurve(to: CGPoint(x: 332.26, y: 200.18), controlPoint1: CGPoint(x: 328.53, y: 186.56), controlPoint2: CGPoint(x: 326.28, y: 194.49))
        bezier4Path.addCurve(to: CGPoint(x: 343.18, y: 203.48), controlPoint1: CGPoint(x: 334.81, y: 202.58), controlPoint2: CGPoint(x: 337.65, y: 203.48))
        bezier4Path.addCurve(to: CGPoint(x: 373.07, y: 225.79), controlPoint1: CGPoint(x: 357.53, y: 203.63), controlPoint2: CGPoint(x: 368.44, y: 211.71))
        bezier4Path.addCurve(to: CGPoint(x: 373.07, y: 243.75), controlPoint1: CGPoint(x: 375.61, y: 233.57), controlPoint2: CGPoint(x: 375.61, y: 234.47))
        bezier4Path.addCurve(to: CGPoint(x: 373.37, y: 257.38), controlPoint1: CGPoint(x: 370.68, y: 253.19), controlPoint2: CGPoint(x: 370.68, y: 253.64))
        bezier4Path.addCurve(to: CGPoint(x: 380.25, y: 261.57), controlPoint1: CGPoint(x: 375.02, y: 259.48), controlPoint2: CGPoint(x: 378.01, y: 261.27))
        bezier4Path.addCurve(to: CGPoint(x: 384.88, y: 204.98), controlPoint1: CGPoint(x: 396.24, y: 263.52), controlPoint2: CGPoint(x: 399.38, y: 224.74))
        bezier4Path.addCurve(to: CGPoint(x: 336.9, y: 184.31), controlPoint1: CGPoint(x: 373.67, y: 189.7), controlPoint2: CGPoint(x: 351.85, y: 180.27))
        bezier4Path.close()
        UIColor.white.setFill()
        bezier4Path.fill()
        ...
        bezier5Path.move(to: CGPoint(x: 280.69, y: 403.21))
        bezier5Path.addCurve(to: CGPoint(x: 243.62, y: 417.89), controlPoint1: CGPoint(x: 260.21, y: 410.7), controlPoint2: CGPoint(x: 243.62, y: 417.29))
        bezier5Path.addCurve(to: CGPoint(x: 261.41, y: 433.16), controlPoint1: CGPoint(x: 243.62, y: 420.43), controlPoint2: CGPoint(x: 254.98, y: 430.16))
        bezier5Path.addCurve(to: CGPoint(x: 279.5, y: 436.3), controlPoint1: CGPoint(x: 266.49, y: 435.4), controlPoint2: CGPoint(x: 271.28, y: 436.3))
        bezier5Path.addCurve(to: CGPoint(x: 298.93, y: 431.21), controlPoint1: CGPoint(x: 289.81, y: 436.3), controlPoint2: CGPoint(x: 291.6, y: 435.85))
        bezier5Path.addCurve(to: CGPoint(x: 317.17, y: 409.5), controlPoint1: CGPoint(x: 308.94, y: 425.07), controlPoint2: CGPoint(x: 313.73, y: 419.53))
        bezier5Path.addCurve(to: CGPoint(x: 318.81, y: 390.19), controlPoint1: CGPoint(x: 319.86, y: 401.57), controlPoint2: CGPoint(x: 320.75, y: 391.23))
        bezier5Path.addCurve(to: CGPoint(x: 280.69, y: 403.21), controlPoint1: CGPoint(x: 318.06, y: 389.89), controlPoint2: CGPoint(x: 301.02, y: 395.73))
        bezier5Path.close()
        UIColor.white.setFill()
        bezier5Path.fill()
